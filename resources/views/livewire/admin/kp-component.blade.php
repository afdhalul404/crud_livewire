                ...
                <div class="col-2">
                    <div wire:model="kategori" wire:change="render" wire:ignore class="select-box position-relative" style="font-size: 14px">
                        <div class="options-container position-absolute col-12">
                            ...
                            <div class="option">
                                <input type="radio" class="radio" id="lokasi" name="category" value="lokasi" />
            ...
            <form wire:submit.prevent="addKp" enctype="multipart/form-data">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <div class="mb-3">
                                <label for="kp_abstrak">Abstrak</label>
                                <textarea wire:model='kp_abstrak' class="form-control @error('kp_abstrak') is-invalid @enderror"
                                    name="kp_abstrak" rows="3"></textarea>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="file">File KP</label>
