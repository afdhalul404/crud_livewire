                ...
                <tr>
                    ...
                    <td>
                        <a wire:click="showFormEdit({{ $item->id }})" style="text-decoration: none"
                            class="badge rounded-pill bg-warning p-2 edit" data-target="#editDosenModal" 
                             name="btn-edit">
                             <i class="ri-pencil-line"></i>
                            </a>
                        <a wire:click="showFormDelete({{ $item->id }})" style="text-decoration: none" class="badge rounded-pill bg-danger p-2 edit" data-target="#deleteDosenModal">
            ...
            <form wire:submit.prevent="deleteDosen">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <h6 class="text-center pt-3 pb-3">Yakin ingin menghapus dosen, dengan NIP <span class="fw-bold">{{ $item->nip }}</span></h6>
