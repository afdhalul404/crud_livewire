...
<div class="container" style="margin-bottom: 250px">
   @if (strlen($search) > 0)
      ...
      @else
         ...
         <a class="text-decoration-none" href="/buku/detail/{{ $item->kode_buku }}">
            <div class="card p-3">
               <h5 class="" style="color: #003487">{{ $item->judul_buku }}</h5>
               <h6 class="fw-normal text-black">{{ $item->penulis }}</h6>
               <h6 class="fw-normal text-black">{{ $item->kategori }}</h6>
            </div>
         </a>
      @endforeach
      ...
      @foreach ($buku as $item)
         <a class="text-decoration-none" href="/buku/detail/{{ $item->kode_buku }}">
            <div class="card p-3">
               ...
               <h6 class="fw-normal text-black">{{ $item->penulis }}</h6>
               <h6 class="fw-normal text-black">{{ $item->kategori }}</h6>
               <h6 class="fw-normal text-black">{{ $item->tahun_terbit }}</h6>
            </div>
         </a>
      @endforeach
      <div class="px-md-3 pt-md-4 d-flex justify-content-center d-md-inline">
         ...
         @else
            ...
            @foreach ($buku as $item)
               <div data-aos="fade-right"
                  class="card card-content border-0 rounded-4 shadow-xm mb-4 bg-body rounded py-md-3 px-2 px-md-0"
                     ...
                     <div class="col-md-8">
                        <div class="item d-flex flex-column" style="padding-top: 20px">
                           <div class="">
                              ...
                              <p class="badge rounded-pill bg-primary" style="font-size: 12px">Buku</p>
                           </div>
